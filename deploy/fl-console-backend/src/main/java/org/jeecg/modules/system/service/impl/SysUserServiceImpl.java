...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements ISysUserService {
    ...
    @Override
    @Transactional
    public void addUserWithFlRole(SysUser user, String roles) {
        this.save(user);
        if (oConvertUtils.isNotEmpty(roles)) {
            String[] arr = roles.split(",");
            for (String roleId : arr) {
                SysUserRole userRole = new SysUserRole(user.getId(), roleId, 0, 1);
                sysUserRoleMapper.insert(userRole);
            }
        }
    }
...
//	@Override
//	@Transactional(rollbackFor = Exception.class)
//	public void updateTenantIds(String id, String relTenantIds, int tenantId, int status) {
//		userMapper.updateTenantIds(id,relTenantIds);
//		sysTenantPermissionMapper.updateStatus(id,tenantId,status);
//	}
//	// 删除用户，更新租户权限表状态
//	@Override
//	@Transactional(rollbackFor = Exception.class)
//	public void deleteUserAndTenantIds(String id, int tenantId, int status) {
//		this.deleteUser(id);
//		sysTenantPermissionMapper.updateStatus(id,tenantId,status);
//	}
